...
macro (addVersionInfo curSrcList)
	find_file(VERSION_INFO_FILE version.txt PATHS . ../ ../../ ../../../ ../../../../ ) # where is version.txt file?
	find_path(BUILD_SYSTEM_PATH buildsys PATHS . ../ ../../ ../../../ ../../../../ ) 
	find_file(BUILDINFO_PY_SCRIPT build_info.py PATHS ${BUILD_SYSTEM_PATH}/buildsys)
	if (NOT VERSION_INFO_FILE) # at first, try to create one:
		file(WRITE "../version.txt" "1.0")
		find_file(VERSION_INFO_FILE version.txt PATHS . ../ ../../ ../../../ )
...
macro (addBuildNumber)
	find_file(BN_INFO_FILE buildnumber.txt PATHS ./ ../ ../../ ../../../ ../../../../ ) # where is buildnumber.txt file?
	find_path(BUILD_SYSTEM_PATH buildsys PATHS . ../ ../../ ../../../ ../../../../ ) 
	find_file(BN_PY_SCRIPT incbuildnumber.py PATHS ${BUILD_SYSTEM_PATH}/buildsys)
	...
	if (NOT BN_INFO_FILE)
		...
		find_file(BN_INFO_FILE buildnumber.txt PATHS ./ ../ ../../ )
		if (NOT BN_INFO_FILE)
