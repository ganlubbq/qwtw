...
#ifdef WIN32 // ===============================================================
	#include <stdlib.h>   //   for RAND_MAX   etc.
	#ifdef _DEBUG
		#include <stdio.h>
	#endif
#endif
...
public:
	...
	*/
	...
	static void fromTextFile(char* fileName, XMType* x0, iiType h, iiType w);
#endif
...
#endif
	/**   matrix inversion (good, but not very efficient).
...
//#endif
	...
	*/
	void print(const XMType* x, iiType hh, iiType ww, unsigned short  p); 
#endif
};
